class AssignedByMeModel {
  ...
  AssignedByMeModel({this.success, this.message, this.data});

  AssignedByMeModel.fromJson(Map<String, dynamic> json) {
...
class TaskUsers {
  ...
  TaskUsers.fromJson(Map<String, dynamic> json) {
    ...
    updatedAt = json['updatedAt'];
    deletedAt = json['deletedAt'];
    assigned_To = json['assignedTo'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.assigned_To != null) {
      data['assignedTo'] = this.assigned_To!.toJson();
    }
    return data;
  }
}
