...
import 'package:team360/src/views/ui/login/reset_password_screen.dart';
                        ...
                        authProvider.inProgress
                          ...
                          child: WidgetFactory.buildButton(
                            ...
                            onPressed: () async {
                              ...
                              // };
                              // print(otp);
                              // authProvider.sendOtpPassword(
                              //     data: data,
                              //     onSuccess: (e, token){
                              //       customWidget.showCustomSuccessSnackbar(context, "${e}");
                              //        Navigator.push(context, MaterialPageRoute(builder: (c)=> ResetPassword(token: token,)));
                              //     },
                              //     onFail: (e){
