class AttendanceCheckOutRequstModel {
  bool? success;
  String? message;
  Data? data;

  AttendanceCheckOutRequstModel({this.success, this.message, this.data});

  AttendanceCheckOutRequstModel.fromJson(Map<String, dynamic> json) {
