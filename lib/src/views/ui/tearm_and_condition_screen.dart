...
import '../../business_logics/models/tearm_and_con_model.dart';
...
class TermAndConScreen extends StatelessWidget {
          ...
          children: [
            ...
            Consumer<PrivacyPolicyProvider>(
              builder: (context,privacyPolicyProvider,child){
                return FutureBuilder<TermAndConModel?>(
                    future: privacyPolicyProvider.getTermAndConData(),
                        ...
                        return
                          Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: HtmlWidget( ''' ${snapsort.data!.data!.termsConditions}''',
