class LoginAfterOtpResponseModel {
  bool? success;
  String? message;
  Data? data;

  LoginAfterOtpResponseModel({this.success, this.message, this.data});

  LoginAfterOtpResponseModel.fromJson(Map<String, dynamic> json) {
